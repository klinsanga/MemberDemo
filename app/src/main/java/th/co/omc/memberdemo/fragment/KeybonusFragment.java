 ...
 */
public class KeybonusFragment extends Fragment implements View.OnClickListener, FaststartAdapter.ClickListener {
    private static final String TAG = KeybonusFragment.class.getSimpleName();
    ...
    @Bind(R.id.key_btn_next) LinearLayout next;
    @Bind(R.id.key_back_btn) RelativeLayout back;
    @Bind(R.id.key_btn_previous) LinearLayout previous;
    @Bind(R.id.key_text_month) CustomTextview currentMonth;
    @Bind(R.id.recyclerview_key) RecyclerView recyclerView;
    @Bind(R.id.keyProgressbarLayout) RelativeLayout progressBar;
    @Bind(R.id.not_found) RelativeLayout no_data;
    public KeybonusFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_keybonus, container, false);
    ...
    private void prepareItem() {
        ...
        new DoParsTask().execute(EndPoints.API_KEY);
    }
