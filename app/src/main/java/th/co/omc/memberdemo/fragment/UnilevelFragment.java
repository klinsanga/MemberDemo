 ...
 */
public class UnilevelFragment extends Fragment implements View.OnClickListener {
    ...
    @Bind(R.id.uni_back_btn) RelativeLayout back;
    @Bind(R.id.uni_btn_next)
    LinearLayout next;
    @Bind(R.id.uni_btn_previous) LinearLayout previous;
    @Bind(R.id.uni_text_month)
    CustomTextview txtmonth;
    @Bind(R.id.recyclerview_uni)
    RecyclerView recyclerView;
    @Bind(R.id.uniProgressBarLayout) RelativeLayout progressBar;
    public UnilevelFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_unilevel, container, false);
    ...
    private void prepareItem() {
        ...
        new DoParsTask().execute(EndPoints.API_UNILEVEL);
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.uni_back_btn :
                ...
                break;
            case R.id.uni_btn_next:
                next.startAnimation(new AnimateButton().animbutton());
                nextMonth();
                break;
            case R.id.uni_btn_previous :
